...
func newRPCServer(cfg *Config, s *server, macService *macaroons.Service,
	...
	routerBackend := &routerrpc.RouterBackend{
		...
		SetChannelEnabled:      func(outpoint wire.OutPoint) error { return s.chanStatusMgr.RequestEnable(outpoint, true) },
		SetChannelDisabled:     func(outpoint wire.OutPoint) error { return s.chanStatusMgr.RequestDisable(outpoint, true) },
